...
#########################################################
#                                                       #
# EmoNet Authors: Jean Kossaifi, Antoine Toisoul, Adrian Bulat #
#                                                       #
#########################################################
...
class EmotionDetector():
    def __init__(self, state_dict_path):
        ...
        self.state_dict = {k.replace('module.',''):v for k,v in state_dict.items()}
        self.model = EmoNet(n_expression=self.n_expression)
